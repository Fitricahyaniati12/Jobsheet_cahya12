...
public class Bank12 {
    ...
    double final_sav_amount, interest, interes_percent = 0.02;
    ...
    interest = sav_period * interes_percent * init_sav_amount;
    final_sav_amount = interest + init_sav_amount;
    System.out.println("interest: "+ interest);
    System.out.println("Final saving emount: "+ final_sav_amount);
    }
}